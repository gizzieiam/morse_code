/*  
    STEP # 1: Encode words that begin with a vowel sound from english 
    to pig latin
    For words that begin with vowel sounds, one just adds "yay" to the
     end.
...
function encodeVowelWord(word) {
  ...
  */
  ...
  /*
      STEP # 10: Create a web form where users can input any message in
       pig latin and get it 
      decoded into plain english.
  */
  
  /*
      BONUS: Go back to encodeText and decodeText and modify it so it 
      can gracefully handle punctuation 
      such as '.', ',', '?'
  */
  
  /* ===============
     Below are some helper variables and functions that are already 
     programmed to help check your progress. YOU DO NOT NEED TO CHANGE 
